        ...
        <div className="w-full grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-3 w-full">
            <div className="group w-full flex items-center justify-between bg-card p-6 rounded-xl ring-1 ring-foreground/10">
              ...
              <div className="p-3 rounded-2xl transition-all duration-300 bg-[#F5F5F7] text-[#1A1A1A] group-hover:bg-[#1A1A1A] group-hover:text-white">
            ...
            <div className="group w-full flex items-center justify-between bg-card p-6 rounded-xl ring-1 ring-foreground/10">
              ...
              <div className="p-3 rounded-2xl transition-all duration-300 bg-[#F5F5F7] text-red-500 group-hover:bg-[#1A1A1A] group-hover:text-white">
