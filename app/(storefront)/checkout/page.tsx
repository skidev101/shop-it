        ...
        <div className="max-w-md w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-[#666666]">
              {mockMode
                ? "Please wait while we test your order flow."
                : "You are being redirected to Paystack to complete your purchase..."}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white min-h-[80vh] flex items-center justify-center px-4 text-center">
        <div className="space-y-6">
          ...
          <p className="text-[#666666] max-w-sm">
            Add some artisan products to your cart before checking out.
          </p>
          <Link href="/shop">
            ...
            <section className="space-y-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#666666]">
                    Where should we send your artisan goods?
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  <label className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-widest ml-1">
                    Full Name
                  </label>
                  <Input
                    {...register("fullName")}
            ...
            <section className="space-y-8">
              ...
              <div className="bg-[#F5F5F7] rounded-[2rem] p-8 space-y-6 opacity-60 pointer-events-none">
                ...
                <p className="text-xs text-[#666666] italic">
                  Payment details will be collected on the next secure step.
                </p>
              </div>
            </section>
          </div>
            ...
            <div className="sticky top-24 space-y-6">
              <div className="bg-[#F5F5F7] rounded-[2.5rem] p-8 text-[#1A1A1A] border border-[#E5E5E5]">
                  ...
                  {items.map((item) => (
                    <div key={item.id} className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-[#999999] uppercase tracking-widest mt-1">
                          QTY: {item.quantity}
                        </p>
                        <p className="text-[11px] font-black mt-1 text-[#1A1A1A]">
                ...
                <div className="flex justify-between items-end mb-8 pt-4 border-t border-[#E5E5E5]">
                  <span className="text-[11px] font-black text-[#999999] uppercase tracking-widest pb-1">
                    Grand Total
                  </span>
              ...
              <div className="bg-[#F5F5F7] rounded-3xl p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-widest">
                    Atlas Buyer Protection
                  </span>
                </div>
                <p className="text-[10px] text-[#666666] leading-relaxed">
                  Your purchase is protected by our global artisan network. 100%
