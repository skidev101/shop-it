    ...
    return (
        <div className="bg-white min-h-screen">
            <div className="mx-auto px-4 lg:px-6 py-8">
                ...
                {/* Filter Bar */}
                <CategoryBar categories={categories} productCount={24506} />
                ...
                <section className="mb-20">
                    <div className="flex items-center justify-between mb-8">
                        ...
                        <Link
                            href="/products"
                            className="flex items-center gap-1 text-xs font-bold text-[#1A1A1A] hover:opacity-70 transition-opacity uppercase tracking-widest"
                        >
                ...
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <p className="text-sm text-[#666666] leading-relaxed">
                        We hand-vet every vendor in the Atlas to ensure
                        uncompromising quality and ethical manufacturing
                        standards.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
                    {[
                        ...
                        <div
                            key={artisan.name}
                            className="flex flex-col items-center text-center p-8 bg-white border border-gray-100 rounded-2xl group hover:shadow-xl transition-all"
                        >
                            ...
                            <h3 className="text-lg font-bold mb-1 group-hover:text-[#0047FF] transition-colors">
                                {artisan.name}
                            </h3>
                            ...
                            <div className="grid grid-cols-3 gap-2 w-full mb-8">
                                {[1, 2, 3].map((p) => (
                                    <div
                                        key={p}
                                        className="aspect-square bg-[#F5F5F7] rounded-lg relative overflow-hidden group-hover:bg-[#E5E5E7] transition-colors"
                                    />
                                ))}
                            </div>
                            ...
                            {idx === 2 ? (
                                <Button
                                    variant="outline"
                                    className="w-full h-11 rounded-xl bg-gray-50 border-none text-[11px] font-black uppercase tracking-widest text-gray-400 hover:bg-[#1A1A1A] hover:text-white transition-all"
                                >
                                    View All Products
                                </Button>
                            ) : (
                                <div className="flex gap-2 w-full">
                                    ...
                                    <Button
                                        variant="outline"
                                        size="icon"
                                        className="h-11 w-11 rounded-xl bg-gray-50 border-none hover:bg-orange-50 hover:text-orange-500 transition-colors"
                                    >
                ...
                <section className="mb-20">
                    <div className="flex items-baseline justify-between mb-8">
                        ...
                        <div className="flex items-center gap-1 text-[10px] font-black text-[#1A1A1A] uppercase tracking-widest cursor-pointer group">
                            Highlighting{" "}
                            <ChevronRight className="h-3 w-3 -rotate-90 group-hover:bg-[#1A1A1A] group-hover:text-white rounded-full transition-all" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                        <div className="md:col-span-4 relative aspect-[4/5] rounded-2xl overflow-hidden group">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-8 flex flex-col justify-end">
                                ...
                                <p className="text-sm text-white/70 mb-6">
                                    Why physical tools are making a comeback in
                                    a digital world and how to curate them.
                                </p>
                                <Button
                                    variant="outline"
                                    className="w-max h-10 px-6 rounded-lg bg-white/10 border-white/20 text-white text-xs font-bold hover:bg-white hover:text-[#1A1A1A] transition-all"
                                >
                                    READ JOURNAL
                                </Button>
                            </div>
                        ...
                        <div className="md:col-span-5 relative aspect-[5/5] md:aspect-auto rounded-2xl overflow-hidden group">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-8 flex flex-col justify-end">
                                ...
                                <p className="text-sm text-white/70 mb-6">
                                    12 vendors redefining the heavy aesthetic
                                    for light spaces in modern architecture.
                                </p>
                                <Button
                                    variant="outline"
                                    className="w-max h-10 px-6 rounded-lg bg-white/10 border-white/20 text-white text-xs font-bold hover:bg-white hover:text-[#1A1A1A] transition-all"
                        ...
                        <div className="md:col-span-3 space-y-8">
                                ...
                                {[
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            <span className="text-[10px] font-black text-gray-200 group-hover:text-[#0047FF]/20 uppercase tracking-widest block mt-1 transition-colors">
                                                {vendor.cat}
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <Link href="/vendors" className="block mt-4 group">
                                <div className="h-12 w-full bg-gray-50 rounded-xl flex items-center justify-center relative overflow-hidden transition-all group-hover:bg-[#1A1A1A]">
                                    <span className="relative z-10 text-[10px] font-black uppercase tracking-widest text-gray-400 group-hover:text-white">
                                        View All Vendors
                                    </span>
                                </div>
                            </Link>
