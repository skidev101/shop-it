      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2 space-y-8">
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label htmlFor="firstName" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">First Name</Label>
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="lastName" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">Last Name</Label>
                        <div className="relative">
                            <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#999999]" />
                            <Input 
                                id="lastName"
                    ...
                    <div className="space-y-2 md:col-span-2">
                        <Label htmlFor="email" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">Email Address</Label>
                        <div className="relative">
                    ...
                    <div className="space-y-2 md:col-span-2">
                        <Label htmlFor="phone" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">Phone Number</Label>
                        <div className="relative">
            ...
            <section className="space-y-6 pt-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <Label htmlFor="currentPass" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">Current Password</Label>
                        <div className="relative">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="newPass" className="text-[10px] font-black uppercase tracking-widest text-[#999999] ml-1">New Password</Label>
                        <div className="relative">
                            <Key className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#999999]" />
                            <Input 
                                id="newPass"
                ...
                <Button variant="outline" className="h-11 px-6 rounded-xl border-[#E5E5E5] text-[10px] font-black uppercase tracking-widest hover:bg-[#1A1A1A] hover:text-white transition-all">
                    Update Password
                </Button>
            </section>
        </div>
        ...
        <div className="space-y-8">
            <Card className="rounded-2xl border-[#F5F5F7] shadow-none overflow-hidden">
                <CardContent className="p-8 flex flex-col items-center">
                    ...
                    <div className="w-full mt-8 pt-8 border-t border-[#F5F5F7] space-y-4">
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#999999]">Status</span>
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-[10px] font-black uppercase tracking-widest text-[#999999]">Language</span>
                            <span className="text-[10px] font-black uppercase text-[#1A1A1A]">English (US)</span>
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            <div className="p-8 bg-rose-50 rounded-2xl border border-rose-100 space-y-4">
                <h4 className="text-sm font-black text-rose-600 uppercase tracking-widest">Danger Zone</h4>
                <p className="text-[11px] text-rose-600/70 font-medium leading-relaxed">
                    Once you delete your account, there is no going back. Please be certain.
                </p>
                <Button variant="outline" className="w-full h-11 rounded-xl border-rose-200 bg-white text-rose-600 text-[10px] font-black uppercase tracking-widest hover:bg-rose-600 hover:text-white hover:border-rose-600 transition-all">
                    Delete Account
                </Button>
            </div>
        </div>
