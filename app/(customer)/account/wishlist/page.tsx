        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {wishlistItems.map((product) => (
            <div key={product.id} className="relative group">
              <ProductCard {...product} />
              <Button className="absolute top-8 right-8 z-20 h-10 w-10 bg-white/90 backdrop-blur-sm rounded-xl shadow-sm text-rose-500 hover:bg-white/70 hover:text-rose-500 transition-all transform flex items-center justify-center border border-rose-100">
