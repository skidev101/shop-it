...
const orders = [
    ...
    },
    {
        ...
        items: [
            {
                name: "Analog Renaissance",
                image: "https://images.unsplash.com/photo-1455390582262-044cdead277a?w=100&q=80",
            },
        ],
    },
];
        ...
        <div className="space-y-8 pb-10">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        variant="outline"
                        className="h-11 w-11 p-0 rounded-xl border-[#E5E5E5] hover:bg-[#F5F5F7]"
                    >
            ...
            <div className="space-y-6">
                {orders.map((order) => (
                    <div
                        key={order.id}
                        className="rounded-2xl bg-white border border-[#F5F5F7] overflow-hidden group hover:border-gray-200 hover:shadow-sm transition-all duration-300"
                    >
                        {/* Order Header */}
                        <div className="p-6 border-b border-[#F5F5F7] bg-[#F9F9F9]/50 flex flex-wrap items-center justify-between gap-6">
                            <div className="flex items-center gap-8 flex-wrap">
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-widest text-[#999999] mb-1.5">
                                        Order ID
                                    </p>
                            ...
                            <div className="flex items-center gap-3">
                                <Button
                                    onClick={() =>
                                        router.push(
                                            `/account/orders/${order.id.replace("#", "").toLowerCase()}`,
                                        )
                                    }
                                    variant="outline"
                                    className="h-10 px-4 rounded-xl border-[#E5E5E5] text-[10px] font-black uppercase tracking-widest hover:bg-[#1A1A1A] hover:text-white transition-all"
                                >
                                    Order Details
                                </Button>
                                    ...
                                    {order.items.map((item, idx) => (
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                <p className="text-[10px] text-[#999999] uppercase font-bold tracking-tight mt-1">
                                                    Quantity: 1 • Variant:
                                                    Default
                                                </p>
                                            </div>
            ...
            <div className="flex justify-center pt-8">
                <Button
                    variant="outline"
                    className="h-12 px-8 rounded-xl border-[#E5E5E5] text-[11px] font-black uppercase tracking-widest hover:bg-[#1A1A1A] hover:text-white transition-all"
                >
                    Load More Orders
                </Button>
            </div>
