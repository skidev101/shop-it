    ...
    <aside className={cn("w-full space-y-12", className)}>
      ...
      <div className="space-y-8">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            className="h-auto p-0 text-[9px] font-black uppercase tracking-widest text-[#0047FF] hover:bg-transparent hover:text-[#0037CC]"
          >
            Reset
          </Button>
        </div>
        ...
        <div className="space-y-4">
          <Label className="text-[11px] font-black uppercase tracking-widest text-[#999999]">
            Price Range
          </Label>
          <div className="flex items-center gap-3">
            <div className="relative flex-1">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[12px] font-bold text-[#999999]">
                $
              </span>
              <Input
                placeholder="0"
                className="pl-6 h-11 bg-[#F5F5F7] border-none rounded-xl text-[12px] font-bold"
              />
            </div>
            ...
            <div className="relative flex-1">
              ...
              <Input
                placeholder="500+"
                className="pl-7 h-11 bg-[#F5F5F7] border-none rounded-xl text-[12px] font-bold"
              />
            </div>
          </div>
        </div>
          ...
          <div className="space-y-2.5">
            {[4.5, 4.0, 3.5].map((rating) => (
              <div key={rating} className="flex items-center space-x-3">
                <Checkbox
                  id={`rating-${rating}`}
                  className="h-5 w-5 rounded-md border-[#E5E5E5] data-[state=checked]:bg-[#1A1A1A]"
                />
                <label
                  htmlFor={`rating-${rating}`}
                  className="text-[12px] font-bold text-[#1A1A1A] flex items-center gap-1.5 cursor-pointer"
                >
                  {rating} & Above{" "}
          ...
          <RadioGroup defaultValue="standard" className="space-y-2.5">
            <div className="flex items-center space-x-3">
              <RadioGroupItem
                value="same-day"
                id="same-day"
                className="h-5 w-5 border-[#E5E5E5] text-[#1A1A1A]"
              />
              <Label
                htmlFor="same-day"
                className="text-[12px] font-bold text-[#1A1A1A] cursor-pointer"
              >
                Same Day Dispatch
              </Label>
            </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <Button
            variant="ghost"
            className="h-auto p-0 text-[9px] font-black uppercase tracking-widest text-[#999999] hover:bg-transparent hover:text-[#1A1A1A]"
          >
            View All
          </Button>
        </div>
      ...
      <div className="relative rounded-3xl bg-[#0047FF] p-8 overflow-hidden group cursor-pointer active:scale-[0.98] transition-all">
        <div className="relative z-10">
          <span className="text-[9px] font-black text-white/50 uppercase tracking-[0.2em] block mb-2">
            Member Exclusive
          </span>
          <h4 className="text-xl font-bold text-white mb-4 leading-tight">
            Join the Atlas Registry for 15% Off
          </h4>
