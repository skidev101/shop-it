      ...
      <div className="mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-20">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-sm text-[#666666] leading-relaxed max-w-sm">
              The premier cartographic authority in modern commerce. We curate the world's finest artisans into a single, seamless digital landscape.
            </p>
            
            <div className="space-y-4">
              <h4 className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-[0.2em]">Subscribe to the Journal</h4>
          ...
          <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-8">
            <div className="space-y-6">
              <h4 className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-[0.2em]">Shop</h4>
              <ul className="space-y-4">
                {footerLinks.shop.map((link) => (
                  <li key={link.label}>
                    <Link href={link.href} className="text-[13px] font-medium text-[#666666] hover:text-[#1A1A1A] transition-colors">
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-[0.2em]">Atlas</h4>
              <ul className="space-y-4">
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-[0.2em]">Support</h4>
              <ul className="space-y-4">
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="space-y-6 text-right md:text-left lg:text-right">
              <h4 className="text-[10px] font-black text-[#1A1A1A] uppercase tracking-[0.2em]">Connect</h4>
              <div className="flex justify-end md:justify-start lg:justify-end gap-4">
                <Link href="#" className="h-10 w-10 rounded-full bg-[#F5F5F7] flex items-center justify-center text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-white transition-all">
            ...
            <div className="space-y-4 text-right md:text-left lg:text-right">
               <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#F5F5F7] rounded-full">
                  ...
                  <span className="text-[9px] font-black text-[#1A1A1A] uppercase tracking-widest">Global Node: Verified</span>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-[#F5F5F7] flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-10">
            <Link href="/privacy" className="text-[10px] font-black text-[#999999] uppercase tracking-[0.2em] hover:text-[#1A1A1A] transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-[10px] font-black text-[#999999] uppercase tracking-[0.2em] hover:text-[#1A1A1A] transition-colors">Terms of Service</Link>
            <Link href="/cookies" className="text-[10px] font-black text-[#999999] uppercase tracking-[0.2em] hover:text-[#1A1A1A] transition-colors">Cookie Settings</Link>
          </div>
