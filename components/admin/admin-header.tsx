...
export function AdminHeader() {
  return (
    <header className="fixed top-0 left-[280px] right-0 h-[90px] bg-white/80 backdrop-blur-md border-b border-[#F0F0F0] flex items-center justify-between px-10 z-40">
      {/* Search Bar */}
      <div className="relative w-full max-w-[600px] group">
        <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-[18px] w-[18px] text-[#999999] group-focus-within:text-[#1A1A1A] transition-colors" />
        <Input 
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center gap-4">
          <div className="text-right">
            <p className="text-[11px] font-black uppercase tracking-widest text-[#1A1A1A]">Admin Authority</p>
            <p className="text-[10px] font-bold text-[#999999]">Superuser Access</p>
          </div>
          <Avatar className="h-11 w-11 rounded-xl border border-[#F0F0F0]">
            <AvatarImage src="https://i.pravatar.cc/150?u=admin" />
            <AvatarFallback className="font-black text-[10px] uppercase">AA</AvatarFallback>
          </Avatar>
        </div>
      </div>
    </header>
